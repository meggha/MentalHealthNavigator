                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div id="yespe" className="checkbox-wrapper">
                        <input
                          type="checkbox"
                          checked={questions[currentQuestionIndex].f === "Yes"}
                          onChange={() =>
                            handleCheckboxChange(currentQuestionIndex, "Yes")
                          }
                        />
                    ...
                    >
                      ...
                      <div id="nope" className="checkbox-wrapper">
                        <input
                          type="checkbox"
                          checked={questions[currentQuestionIndex].f === "No"}
                          onChange={() =>
                            handleCheckboxChange(currentQuestionIndex, "No")
                          }
                        />
                        <svg viewBox="0 0 35.6 35.6">
                          <circle
